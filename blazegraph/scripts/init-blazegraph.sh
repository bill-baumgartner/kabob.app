...
cd /var/lib/jetty
java -Xmx40G -Dcom.bigdata.rdf.sail.webapp.ConfigParams.propertyFile=/RWStore.properties -Dlog4j.configuration=file:///log4j.properties -DSTOP.KEY=KEY -DSTOP.PORT=2222 -jar /usr/local/jetty/start.jar
