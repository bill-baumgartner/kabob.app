...
docker run --rm --net virtuoso-net-${KB_KEY} --volumes-from kabob_data-${KB_KEY} --volumes-from virtuoso-load-requests-${KB_KEY} billbaumgartner/kabob-base:0.3 /kabob.git/scripts/docker/virtuoso-specific/build-from-scratch.sh ${KB_NAME}
